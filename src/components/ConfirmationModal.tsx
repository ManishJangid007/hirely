                ...
                <div className="mt-3">
                    ...
                    <div className="flex justify-end space-x-3 pt-6">
                        ...
                        <button
                            ...
                            className={`px-4 py-2 border border-transparent rounded-full shadow-sm text-sm font-medium text-white ${confirmButtonClass} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all duration-200`}
                        >
                            {confirmText}
                        </button>
                    </div>
